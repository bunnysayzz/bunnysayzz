...
**[Utilix](https://github.com/bunnysayzz/utilix)** is what I am building right now. A lightweight macOS menu-bar app that puts 25+ everyday utilities in one place, so you stop juggling single-purpose apps.
...
- Command palette on ⌘Space, search commands, apps, and settings from anywhere
- Clipboard history, snippets with expansion while typing, temp notes
- Mac Vision OCR, translate and polish, QR generator, file compressor
- Window snap, calendar meetings with one-click join, pomodoro, battery and network views
- Optional AI chat with tools (bring your own API key), global shortcuts, launch at login
- Your data stays on your Mac. No account, no server for core features

Details, screenshots, docs, and issue templates are in the [Utilix repo](https://github.com/bunnysayzz/utilix). Bug reports and ideas are welcome there.
